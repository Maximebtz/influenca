...
function Footer() {
  return (
    <footer className="min-h-max w-full flex flex-col items-center overflow-hidden px-8 pb-4 pt-12 max-md:max-w-full max-md:px-5">
      <div className="w-full flex flex-wrap items-center justify-center gap-10 self-stretch px-12 max-md:max-w-full max-md:px-5">
        <div className="min-h-[96px] min-w-[240px] w-[400px] flex flex-col items-center justify-between self-stretch my-auto">
          <div className="min-h-[96px] size-24 flex items-center justify-center gap-2.5 rounded-[48px] bg-neutral-950 px-9 max-md:px-5">
            <Image
              loading="lazy"
        ...
        <div className="basis-0 flex-1 shrink flex flex-wrap items-start justify-center gap-10 self-stretch px-12 py-5 my-auto text-sm font-medium leading-10 tracking-[4.62px] text-white text-opacity-80 min-w-[240px] max-md:max-w-full max-md:px-5">
          <ul>
            <li>
      ...
      <div className="mt-8 h-[39px] flex items-center gap-6">
        <Link href="/">
      ...
      <div className="mt-8 text-xs font-medium leading-4 tracking-[3.3px] text-white">
